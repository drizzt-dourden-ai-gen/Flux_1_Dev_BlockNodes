# comfyui/custom_nodes/flux_S6-S12_block.py
# S-block control for S6–S12 (Mid-Level Detail)
...
class FluxS6S12Block:
    """
    Controls S6–S12 (Mid-Level Detail).
...
NODE_CLASS_MAPPINGS = {
    "FluxS6S12Block": FluxS6S12Block,
}

NODE_DISPLAY_NAME_MAPPINGS = {
    "FluxS6S12Block": "Flux S‑Block Control (S6–S12)",
}
